...
public class DialogTrigger : MonoBehaviour
{
    ...
    [TextArea] public string[] afterShadowLines;
    ...
    public bool starInserted = false;
    ...
    private async Task StartDialog()
    {
        ...
        if (lampOff && !starInserted)
            linesToShow = afterShadowLines;
        else if (lampOff && starInserted)
        ...
        if (lampOff && starInserted && doorLight != null)
        {
